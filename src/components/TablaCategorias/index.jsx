...
export default function TablaCategoria(props) {
  ...
  const { categorias, editarCategoria, eliminarCategoria } = props
          ...
          {rows.map((row) => (
            ...
            >
              <TableCell 
                ...
                sx={{ 
                  color: `#f5f5f5`,
                  borderBottom: `4px solid #000000e5`,
                  borderRight: `4px solid #000000e5`
                }}>
                    {row.titulo}
              </TableCell>
              <TableCell 
