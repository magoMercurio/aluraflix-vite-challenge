  ...
  return (
    <TableContainer component={Paper} >
      ...
      sx={{ 
        ...
        <TableHead >
          <TableRow >
            <TableCell align="left" sx={{ color: `#f5f5f5`, border: `4px solid #2A7AE4
`  }}>Nombre</TableCell>
            <TableCell align="left" sx={{ color: `#f5f5f5`, border: `4px solid #2A7AE4
`  }}>Descripción</TableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              <TableCell component="th" scope="row" sx={{ color: `#f5f5f5`, borderBottom: `4px solid #000000e5` }}>{row.titulo}</TableCell>
